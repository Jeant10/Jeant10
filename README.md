...
[![My Skills](https://skillicons.dev/icons?i=js,html,css,nodejs,react,angular,mysql,laravel,php,ts,py,r,java,c,cpp,cs,visualstudio,git,github,vscode,wordpress,netlify,heroku,firebase,androidstudio,gradle,flutter,bash,kali,arduino,nginx,docker,vercel,unity)](https://skillicons.dev)
